<template>
  <div class="box">
    ...
    <div id="polina">
      ...
      <div
        style="margin-top: 60px;width: 100%;height: 60px;text-align: center;position:relative;background: none"
      >
        <router-link to="/tableDesign" style="background: none;">
          <button class="btn" style="left: 50%;position: absolute;margin-left: -210px">表格编辑器</button>
        </router-link>
        <router-link to="/reportDesign" style="background: none;">
          <button class="btn" style="margin-left: 50%;position: absolute;left: -60px;">报表设计器</button>
        </router-link>
        <router-link to="/formList" style="background: none;">
          <button class="btn" style="position:absolute;margin-left: 50%;left: 100px;">数据表单引擎</button>
        </router-link>

        <router-link to="/pageHome" style="background: none;">
          <button class="btn" style="margin-left: 50%;position: absolute;left: 260px;">流程图引擎</button>
        </router-link>
      </div>
    </div>
  </div>
