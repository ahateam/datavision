				...
				<el-container>
					<el-main class="main-box">
						...
						<div class="info-box">
							...
							<div class="tab-box">
								<div class="tab-title">
									<div :class="tabActive==index?'tab-item-title tab-active':'tab-item-title'" v-for="(item,index) in tabList"
									 :key="index" @click="tabActive = index">
										{{item.title}}
									</div>
								...
								<div class="tab-item">
									...
									<div v-if="tabActive == 0">
										<div class="search-box">
											<el-input size="small" placeholder="输入关键字进行过滤" v-model="searchTableData">
											</el-input>
										</div>
										<div class="tab-item-content">
											<el-tree class="filter-tree" :data="tabList[0].content" :props="defaultProps" default-expand-all
									...
									<div v-if="tabActive == 1">
										...
										<el-tabs v-model="permissionTabActive">
											...
											<el-tab-pane :label="item.title" :key="index" v-for="(item,index) in tabList[1].content" @click="permissionTabActive = index">

												<div class="permission-list" v-for="(item1,index1) in item.list" :key="index1">
													{{item1.name}}
												</div>
